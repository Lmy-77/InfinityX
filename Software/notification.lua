...
Content.Text = "The game that InfinityX is trying to run is not compatible with the script. To find out which games are supported, go to my RScripts profile"
