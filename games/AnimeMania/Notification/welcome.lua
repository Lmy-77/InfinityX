...
Content.Text = "This script was developed by Lmy77/InfinityMercury, the script is still in beta test so some functions may stop working (like god mode when the character resets) but this will be fixed soon."
